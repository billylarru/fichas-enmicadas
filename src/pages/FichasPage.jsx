...
const FichasPage = () => {
    ...
    return (
        <div className="contenedor-principal">
            ...
            <button onClick={handleExportConfig} className="boton-imprimir btn btn-success"><i className='fa fa-file'></i> <i className="bi bi-file-earmark-arrow-down"></i> Exportar Configuración</button>
            <label className="boton-imprimir btn btn-warning">
                <i className="bi bi-file-earmark-arrow-up"></i> Importar Configuración
                <input
                    type="file"
